...
public void room1Game() { //Taught by Game Dev CPT
  charView = charRight;
...
//Final Level ***************************************************************
public void roomBossGraphics() {
  PFont sideTextFont = loadFont("Bahnschrift-48.vlw");

  //GRAPHICS
  stroke(0);
  background(0xffF5A802);
  fill(0xffE86E5B);
  rect(180, 0, 440, 250); 
  fill(0xff40C400);
...
//Room 1
public void congratulatoryMessage1() {
  ...
  score1 = 1000-((minutes*60)+(secs*0.6f));
...
//Room 2---------------------------------------------------------------------------------------------------
public void congratulatoryMessage2() {
  ...
  score2 = 1000-((minutes*60)+(secs*0.6f));
...
//Room 3 ----------------------------------------------------------------------------------------------------
public void congratulatoryMessage3() {
  //PFont and PImage Variables
  headingFont = loadFont("Consolas-Bold-55.vlw");
  bodyFont = loadFont("MongolianBaiti-48.vlw");
  subtextFont = loadFont("SegoeUI-Semibold-30.vlw");
  ...
  score3 = 1000-((minutes*60)+(secs*0.6f));
...
//Boss Room ----------------------------------------------------------------------------------------------------------
public void congratulatoryMessageFinal() {
  //PFont and PImage Variables
  headingFont = loadFont("Consolas-Bold-55.vlw");
  bodyFont = loadFont("MongolianBaiti-48.vlw");
  subtextFont = loadFont("SegoeUI-Semibold-30.vlw");
  ...
  score4 = 1000-((minutes*60)+(secs*0.6f));
  //Local Variables
...
public char getChar(String s)
{
  ...
  public void settings() {  size(800, 550); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "EscapeRoom" };
    if (passedArgs != null) {
